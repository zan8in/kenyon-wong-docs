...
[![](assets/1706232647-5060f36ce3d11817e83e454cccf20850.png)](https://xzfile.aliyuncs.com/media/upload/picture/20240124161413-8f4949ca-ba90-1.png)  
然后对经过解压缩后的数据利用 CustomObjectInputStream 进行包装，再调用 readObject() 方法实现反序列化  
[![](assets/1706232647-5d82913357dae14cc4fbe1a5ff6c716e.png)](https://xzfile.aliyuncs.com/media/upload/picture/20240124161736-081d6a84-ba91-1.png)  
CustomObjectInputStream 继承 ObjectInputStream，其构造方法调用父类的构造方法，和正常反序列化差不多  
[![](assets/1706232647-a62e220458a2c2e011d99ec84f3ccd44.png)](https://xzfile.aliyuncs.com/media/upload/picture/20240124183747-9da75d5e-baa4-1.png)  
所以我们构造的序列化数据，要先经过 gzip 压缩，再向漏洞接口发送  
[![](assets/1706232647-3b37713f2354c01cc63a7d96153234df.png)](https://xzfile.aliyuncs.com/media/upload/picture/20240124184033-008e478e-baa5-1.png)  
如何构造序列化数据呢，可以利用 cb 链或者 hibernate 链，需要注意的是这里的包名不是正常 maven 下载的依赖的包名，所以有些 payload 构造也会有所差别，构造 hibernate 链  
[![](assets/1706232647-bfce133a076b9adf8ceac90596066577.png)](https://xzfile.aliyuncs.com/media/upload/picture/20240124184545-ba4d5eb2-baa5-1.png)
...
[![](assets/1706232647-f9ec302553c771bca089ee761f9ec4df.png)](https://xzfile.aliyuncs.com/media/upload/picture/20240124190345-3e4f4638-baa8-1.png)  
...
[![](assets/1706232647-3c5a70b6069cec5e837006fcb9064797.png)](https://xzfile.aliyuncs.com/media/upload/picture/20240124191459-cfd83e74-baa9-1.png)  
这里是用来触发node的toSting方法，我们可以用XString#equals替换BadAttributeValueExpException来触发toSting方法  
[![](assets/1706232647-12dfd82fae8ab0cfc26c0c76aefd456c.png)](https://xzfile.aliyuncs.com/media/upload/picture/20240124191606-f7e44110-baa9-1.png)  
spring环境下可以利用HotSwappableTargetSource#equals来触发XString的equals方法  
[![](assets/1706232647-6a5b87f9d2434d7eb64b16c4099d9d56.png)](https://xzfile.aliyuncs.com/media/upload/picture/20240124191637-0a7e5d60-baaa-1.png)  
...
[![](assets/1706232647-32e640c6db5fe9a8f77909ad703dcc9d.png)](https://xzfile.aliyuncs.com/media/upload/picture/20240124192238-e18f7bc2-baaa-1.png)  
